...
export const TOP_SPENDING_BRANDS: TopSpender[] = [
  ...
  { rank: 11, brand: 'P1 Sim Rigs', industry: 'Sim Racing / Hardware', estimatedSpend: '$500K-$2M', platforms: ['YouTube', 'Twitch'], campaignTypes: ['Product Integration', 'Sponsored Stream', 'Review'], markets: ['Global', 'ANZ'], frequency: 'Ongoing + product launches', opportunity: 'Neil connection. Influencer already identified. Need management + attribution (UTM/promo codes for e-commerce). Direct relationship = high margin.' },
  { rank: 12, brand: 'Fanatec / Endor AG', industry: 'Sim Racing / Hardware', estimatedSpend: '$2M-$5M', platforms: ['YouTube', 'Twitch'], campaignTypes: ['Product Review', 'Sponsored Stream', 'Unboxing'], markets: ['Global'], frequency: 'Product launches', opportunity: 'Sim racing vertical growing fast. Pair with P1 pitch. Same creator pool.' },
  ...
  { rank: 17, brand: 'EA Sports (FC / Madden / UFC)', industry: 'Sports Gaming', estimatedSpend: '$15M+', platforms: ['YouTube', 'TikTok', 'Twitch'], campaignTypes: ['Sponsored Video', 'Early Access', 'Tournament'], markets: ['Global'], frequency: 'Annual launches + updates', opportunity: 'Massive annual launch cycles. Sports gaming creators = underserved niche.' },
  ...
  { rank: 26, brand: 'Take-Two / 2K / Rockstar', industry: 'Publisher', estimatedSpend: '$15M+', platforms: ['YouTube', 'Twitch', 'TikTok'], campaignTypes: ['Early Access', 'Sponsored Stream', 'Event'], markets: ['Global'], frequency: 'Around launches', opportunity: 'GTA VI hype cycle. NBA 2K annual. Massive budgets when active.' },
  ...
  { rank: 32, brand: 'Plarium (Raid: Shadow Legends)', industry: 'Mobile Gaming', estimatedSpend: '$20M+', platforms: ['YouTube'], campaignTypes: ['Video Integration', 'Sponsored Segment'], markets: ['Global'], frequency: 'Continuous', opportunity: 'One of the biggest YouTube sponsors ever. Always buying integrations. Easy money.' },
  ...
  { rank: 39, brand: 'NordVPN / Surfshark', industry: 'Tech / VPN', estimatedSpend: '$20M+', platforms: ['YouTube'], campaignTypes: ['Video Integration', 'Sponsored Segment'], markets: ['Global'], frequency: 'Continuous', opportunity: 'Biggest YouTube sponsor category. Always buying. Gaming creators = perfect fit.' },
  ...
  { rank: 41, brand: 'Thrustmaster', industry: 'Sim Racing / Hardware', estimatedSpend: '$2M-$4M', platforms: ['YouTube', 'Twitch'], campaignTypes: ['Product Review', 'Sponsored Stream', 'Racing Content'], markets: ['Global'], frequency: 'Product launches', opportunity: 'Sim racing hardware. Pairs with P1 pitch. Same creator ecosystem as Fanatec.' },
  { rank: 42, brand: 'iRacing', industry: 'Sim Racing / Software', estimatedSpend: '$1M-$3M', platforms: ['YouTube', 'Twitch'], campaignTypes: ['Sponsored Stream', 'Tournament', 'Content Series'], markets: ['Global'], frequency: 'Season launches', opportunity: 'Premium sim racing platform. Esports angle. Pairs with hardware brands.' },
  { rank: 43, brand: 'Assetto Corsa / Kunos', industry: 'Sim Racing / Software', estimatedSpend: '$500K-$1M', platforms: ['YouTube'], campaignTypes: ['Early Access', 'Review', 'Sponsored Video'], markets: ['Global'], frequency: 'Around launches', opportunity: 'Assetto Corsa EVO launch = campaign window. Sim racing content growing fast.' },
  ...
  { rank: 49, brand: 'Betway / Stake (Esports Betting)', industry: 'Esports Betting', estimatedSpend: '$10M+', platforms: ['Twitch', 'YouTube'], campaignTypes: ['Sponsored Stream', 'Tournament Sponsorship'], markets: ['Global (regulated markets)'], frequency: 'Continuous', opportunity: 'Huge budgets but brand safety considerations. Esports-focused creators only.' },
