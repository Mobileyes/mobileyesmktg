...
export const INDUSTRY_EVENTS_2026: IndustryEvent[] = [
  ...
  },
  {
    ...
    name: 'Supanova',
    shortName: 'Supanova',
    location: 'Sydney Showgrounds, Sydney Olympic Park, NSW',
    dates: { start: '2026-06-19', end: '2026-06-21' },
    website: 'https://supanova.com.au',
    type: 'EXPO',
    relevance: 'CRITICAL',
    description: 'Major Australian pop culture/gaming expo. Brands activate, creators attend, networking opportunities. Joel has 3-day Supa-Fan Weekend Pass confirmed (Ticket ID 46963932).',
