...
const PARTNERS = [
  ...
  {
    name: 'Kick (Ryan)',
    type: 'Platform / Content Agency Deal',
    status: 'TARGET',
    value: 'Joel helped build Kick at AWS (Twitch infrastructure). Went to DreamHack with founding team. Target: land content agency contract with Ryan. Gamefluence becomes Kicks gaming content partner in APAC. Manage creators, produce sponsored streams, drive viewership.',
  ...
  {
    name: 'Eddie (F1)',
    type: 'Premium Content / Talent',
    status: 'TARGET',
    value: 'Joel + Neil both know Eddie personally. Dream content: Eddie does his F1 sim lap on a P1 rig. Massive credibility moment for P1 + Gamefluence + Kick. Only activates if Kick deal lands first.',
    website: null,
    action: null,
    actionLabel: null,
  },
