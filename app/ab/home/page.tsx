...
export default function ABHomePage() {
  return (
    <div style={{ background: '#0B0F2E' }}>
      {/* Nav */}
      <nav
        className="fixed top-6 left-0 right-0 z-50 flex items-center justify-between px-6 max-w-7xl mx-auto"
        style={{ height: 52, borderBottom: '1px solid #1E2A5E' }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 w-full">
          ...
          <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 pt-12" style={{ borderTop: '1px solid #1E2A5E' }}>
            ...
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: 'rgba(255,255,255,0.5)' }}>Years gaming industry</p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={step.num} className="p-6 rounded-2xl" style={{ backgroundColor: '#0F1330', border: '1px solid #1E2A5E' }}>
                <p className="font-mono text-sm mb-4" style={{ color: '#3B82F6', fontFamily: 'var(--font-space-mono)' }}>{step.num}</p>
      ...
      <section className="py-32 px-6 relative overflow-hidden" style={{ background: '#080C24' }}>
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/ab/brief" className="px-8 py-4 text-white rounded-xl font-semibold text-lg" style={{ border: '1px solid #1E2A5E' }}>
              Brand Brief
            </Link>
          </div>
