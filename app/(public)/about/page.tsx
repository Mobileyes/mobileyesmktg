          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-4 leading-relaxed text-lg" style={{ color: 'rgba(255,255,255,0.7)' }}>
                ...
                <p>
                  Led gaming partnerships at <strong className="text-white">AWS</strong>: earned 9 figures in gaming revenue. Multi-contract deals across Amazon Prime Gaming, mobile campaigns on Amazon Fire devices for streaming platform Kick, leveraged Twitch infrastructure at AWS to help build Kick alongside its founding team — nobody else did this. Worked directly with Kick leadership at DreamHack, and leveraged AI and data at AWS to deliver a 95% query performance improvement for Easygo (parent company of Kick and Stake) across their global gaming data platform.
                </p>
                <p>
